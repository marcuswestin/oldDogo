...
function getMessagesForConversation(conversationId, afterMessageId, callback) {
	...
	var sql = 'SELECT messageId, fromPersonId, clientUid, conversationId, type, sentTime, payloadJson FROM message WHERE conversationId=? AND messageId>? ORDER BY messageId'
