...
module.exports = function renderWelcome(view, welcomeDuration) {
	var arrow = div(graphics.graphic('listMenuArrow', 16, 16), style({ position:'absolute', right:units*5.5 }, translate.y(3)))
	var plus = graphics.graphic('listMenuPlus', 20, 20, translate.y(2), { position:'absolute', left:units*5.5 })
	var person = graphics.graphic('listMenuPerson', 20, 20, translate.y(1), { position:'absolute', left:units*5.5 })
