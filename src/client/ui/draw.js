...
function render(_opts) {
	opts = options(_opts, { onHide:null, onSend:null, img:null })
	...
	return $ui = $(div('draw',
		div('close button', 'X', button(function() { opts.onHide() }), style({ bottom:height - 30, left:3 })),
...
function sendImage() {
	...
	$rotateCanvas.remove()
	opts.onSend(data, canvasSize.width, canvasSize.height)
}
